...
import ImagemVagas from '../assets/vagas.jpg';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
              {vagas.map(vaga => (
                <div key={vaga.id} className="flex flex-col bg-white rounded-[2.5rem] p-8 md:p-10 shadow-md hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 border border-gray-100 group">
                  ...
                  <a 
                    href={`https://wa.me/5511995987197?text=${encodeURIComponent(`Olá! Vim pelo site e gostaria de me candidatar à vaga de ${vaga.titulo}.`)}`}
                    target="_blank" 
