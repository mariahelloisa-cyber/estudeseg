...
export default function Inicio() {
  ...
  <img key={`l1-${selo.id || i}`} src={selo.imagem_url} alt={selo.nome} className="h-14 md:h-20 w-auto object-contain inline-block transition-transform hover:scale-105 duration-300" />
            ...
            <div className="animate-marquee flex gap-16 shrink-0 justify-around min-w-full px-8 items-center">
              {listaSelos.map((selo, i) => (
  <img key={`l2-${selo.id || i}`} src={selo.imagem_url} alt={selo.nome} className="h-14 md:h-20 w-auto object-contain inline-block transition-transform hover:scale-105 duration-300" />
))}
            </div>
          </div>
        </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    <div className="text-center max-w-3xl mx-auto mb-12">
      ...
      <h2 className="text-3xl md:text-5xl font-extrabold text-[#1a103c] mb-4 tracking-tight">
        Conteúdos para <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#fed106] to-[#6039d4]">impulsionar <br className="hidden md:block" /> sua carreira.</span>
      </h2>
            ...
            >
              ...
              <div className="relative z-10 mt-auto p-6 md:p-8 flex flex-col">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 rounded-full bg-[#fed106] text-white flex items-center justify-center transform group-hover:bg-[#a61058] group-hover:translate-x-1 transition-all">
    ...
    <div className="mt-12 flex justify-center">
      <a
        href="/blog"
        className="bg-[#fed106] hover:bg-[#a61058] text-white font-extrabold text-sm py-4 px-8 rounded-full transition-colors flex items-center gap-2 shadow-md cursor-pointer"
      >
