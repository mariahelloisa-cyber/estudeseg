...
import logoLatec from '../assets/logo-estud.webp'; 
  ...
  return (
    ...
    >
      <div className="bg-white rounded-[32px] p-8 sm:p-12 shadow-2xl w-full max-w-md border border-gray-50 flex flex-col items-center relative z-10 animate-in fade-in zoom-in-95 duration-300">
        ...
        <h2 className="text-2xl font-black text-[#000000] tracking-tight text-center">Painel Administrativo</h2>
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5 text-left">
          ...
          <button 
            type="submit" 
            disabled={carregando}
            className="w-full bg-gradient-to-r from-[#fed106] to-[#fed106]/60 hover:opacity-95 text-black py-4 rounded-xl font-extrabold uppercase tracking-wider text-xs shadow-lg shadow-pink-100 transition-all active:scale-[0.99] flex items-center justify-center gap-2 cursor-pointer mt-6 disabled:opacity-50"
          >
