    ...
    <div className="min-h-screen bg-gray-50 flex flex-col overflow-x-hidden">
      ...
      {banners.length > 0 && (
        <div className="w-full bg-white relative group">
          ...
          {/* --- FAIXA DE CONFIANÇA: flutua sobre a borda inferior do banner (oculta no mobile) --- */}
          <div className="hidden sm:block max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 sm:-mt-8 relative z-10 pb-6 sm:pb-3">
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 mt-6 flex justify-center">
        <a
          href={`https://wa.me/5511995987197?text=${encodeURIComponent('Olá! Vim pelo site e gostaria de fazer minha consultoria gratuita.')}`}
          target="_blank"
          rel="noreferrer"
              ...
              return (
                <div key={grupo.chave} className="flex flex-col">
                  <div className="flex items-end justify-between gap-4 mb-5">
                    ...
                    <a href={`/cursos?grupo=${grupo.chave}`} className="inline-flex items-center gap-1 text-xs font-bold text-gray-500 hover:text-black transition-colors shrink-0">
                      Ver todos
